...
namespace If.Itc.Integrations.Web.Migrations
{
    ...
    [Migration("20200616085746_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("If.Itc.Integrations.Web.Context.System", b =>
                {
                    b.Property<string>("SystemCode")
                        .HasColumnType("nvarchar(8)")
                        .HasMaxLength(8);
            ...
            modelBuilder.Entity("If.Itc.Integrations.Web.Context.Integration", b =>
                {
                    ...
                    b.HasOne("If.Itc.Integrations.Web.Context.System", "System")
                        .WithMany("Integrations")
                        .HasForeignKey("SystemCode1");
                });
